...
uint8_t errorFlags = 0; //integer to save error flags (bitwise)

BLEService systemService("74ac19c2-5aa1-4419-9426-dab1961d0b9f");  // Custom service UUID
BLEUnsignedShortCharacteristic waterLevel("74ac19c2-5aa1-4419-9426-dab1961d0b9f1", BLERead | BLEIndicate);
